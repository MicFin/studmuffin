...
DietaryRestriction.create(name: "Oral Allergy Syndrome", category: "disease", order: 208)
DietaryRestriction.create(name: "EoE", category: "disease", order: 205, description: "Eosinophilic Esophogitis")
DietaryRestriction.create(name: "CSID", category: "disease", order: 204, description: "Congenital Sucrase-Isomaltase Deficiency")
DietaryRestriction.create(name: "FPIES", category: "disease", order: 206, description: "Food Protein Induced Enterocolitis Syndrome")
DietaryRestriction.create(name: "IBS", category: "disease", order: 207, description: "Irritable Bowel Syndrome")
