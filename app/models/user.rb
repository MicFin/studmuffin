class User < ActiveRecord::Base
  ...
  validates_presence_of :phone_number, {message: "is an invalid number.  Please provide your RDN with a number to call in case of a connection issue.  We will ONLY call you during a consultation.  And we will NEVER share your number." }
