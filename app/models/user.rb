class User < ActiveRecord::Base
  ...
  validates_presence_of :phone_number, {message: "is an invalid number.  Your phone number will ONLY be used in case of a connection problem.  Otherwise we will NEVER call you.  And we will NEVER share your number." }
